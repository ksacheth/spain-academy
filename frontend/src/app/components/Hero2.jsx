...
//           <img src="/logo.png" alt="Logo" className="w-[275px] ml-[7vw] border-1" />
    
//             <div className="absolute w-[43.8vw] border-1 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
//             <TextReveal>
...
//           {/* w-[211px] */}
//           <img src="/green.png" alt="Hero Image" className="absolute top-[18.18%] left-[27.38%]  w-[clamp(100px,14.5vw,300px)] -rotate-18" />
//           {/* <img src="/yellow.png" alt="Hero Image" className="absolute -top-47 left-[75.68%] w-[178px]" /> */}
//           <img src="/yellow.png" alt="Hero Image" className="absolute -top-47 left-[75.68%] w-[clamp(100px,12.4vw,300px)] rotate-18" />
//           {/* <img src="/red.png" alt="Hero Image" className="absolute w-[290px] bottom-0 left-[73.80%]" /> */}
//           <img src="/red.png" alt="Hero Image" className="absolute w-[clamp(130px,19.5vw,300px)] bottom-0 left-[73.80%]" />
//         </div>
//       </div>
//     </div>
//   );
  ...
  return (
    <div>
      ...
      <div className="h-[80vh] bg-[#F9F9F9] rounded-b-[70px] flex">
        <div className="flex flex-col w-[60vw] h-full">
          ...
          <div className="basis-1/5 flex items-center">
            <img
              src="/logo.png"
              alt="Spain Academy"
              className="w-[clamp(100px,19vw,300px)] ml-[7vw] "
            />
          </div>
        ...
        {/* RIGHT: images */}
        <div className="relative overflow-visible w-[40vw]">
          <img
            src="/green.png"
            alt=""
            className="absolute top-[10%] left-[27.38%] w-[clamp(100px,14.5vw,300px)] -rotate-18"
            aria-hidden="true"
          />
          <img
            src="/yellow.png"
            alt=""
            className="absolute -top-47 left-[75.68%] w-[clamp(100px,12.4vw,300px)] rotate-18"
            aria-hidden="true"
          />
          <img
            src="/red.png"
            alt=""
            className="absolute w-[clamp(130px,19.5vw,300px)] bottom-0 left-[73.80%]"
            aria-hidden="true"
          />
        </div>
      </div>
