          ...
          <TextReveal>
            <div>
              ...
              <p className="mt-[0.5rem] font-inter sm:text-[1rem] sm:pr-[0rem] sm:leading-[1.1] md:text-[1.1rem] ">
                ...
                wondering about visas, language, or just how to survive without
                your mom's cooking, we've got answers that are bold, clear, and
                a little bit fun; just like Spain Academy.
              </p>
            </div>
          </TextReveal>
        </div>
