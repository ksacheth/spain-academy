    ...
    <div className="h-[380vh] bg-[#F9F9F9] rounded-[100px] relative">
      <div className="bg-transparent z-3 h-100%">
        ...
        >
          ...
          />
          <rect className="cls-5 fill-none" width="1" height="624" />
          <path
            className="cls-2 fill-none"
            d="M584,0h1v624h-1v-5.5c0-203.82,0-407.68,0-611.5V0Z"
          />
          <rect className="cls-3 fill-none" y="624" width="585" height="1" />
          <path
            ref={pathRef}
            className="cls-1 "
      ...
      <div>
        <img
          ...
          alt="tree"
          loading="lazy"
          className="picture5 w-[clamp(80px,12vw,127px)]"
        />
      </div>
      <div>
        <img
          ...
          alt="tree"
          loading="lazy"
          className="picture6 w-[clamp(140px,22vw,281px)]"
        />
      </div>
      <div>
        <img
          ...
          alt="tree"
          loading="lazy"
          className="picture7 w-[clamp(60px,9vw,92px)]"
        />
      </div>
      <div>
        <img
          ...
          alt="tree"
          loading="lazy"
          className="picture8 w-[clamp(250px,45vw,573px)]"
        />
      </div>
      <div>
        <img
          ...
          alt="tree"
          loading="lazy"
          className="picture9 w-[clamp(160px,27vw,328px)]"
        />
      </div>
      <div className="bg-transparent z-3">
        <svg
          id="Layer_1"
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
