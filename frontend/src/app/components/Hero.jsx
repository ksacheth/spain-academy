...
export default function Hero() {
  return (
    <div
      className="flex h-[clamp(500px,50vw,1000px)] text-black mx-auto  -1" 
    >
      <div className="flex w-[45.8%] shrink-0 flex-col justify-center bg-white pl-18  -1">
        <div className="w-[92%] max-w-[943.8464px] mx-auto  -1">
          <div className="font-serif leading-[1.14] tracking-[-0.045em] text-[clamp(1.875rem,4.5vw,108px)] text-[#009839]  -1">
            <TextReveal>
              <h1>
          ...
          <TextReveal>
            <div className="mt-4 font-sans-alt leading-[1.3] tracking-[-0.035em] text-black text-[clamp(1rem,1.5vw,36px)]  -1">
        ...
        <div className="mt-10  -1 w-fit ml-5">
          <Button2>Book a Consultation</Button2>
        </div>
      </div>
      <div className="grow bg-transparent overflow-visible z-10  -1">
